...
def build_session_metadata(
    *,
    ...
    lsl_control_stream = build_control_lsl_metadata(config, processing_mode)
    lsl_event_stream = build_event_lsl_metadata(config, processing_mode)
    lsl_timing = {
        **build_lsl_timing_metadata(config),
